...
import 'dart:core';
import 'model/utils/device_info.dart';
import 'model/utils/screen_select_dialog.dart';
import 'model/utils/turn.dart';
import 'model/utils/websocket.dart';
import 'model/call_sample/call_sample.dart';
import 'model/call_sample/signaling.dart';
...
class _CallSampleState extends State<CallSample> {
  ...
  initState() {
    super.initState();
    initRenderers();
    _signaling?.invite(_selfId!, 'data', true);
    // _signaling?.accept(_selfId!, 'data');
    // _connect(context);
  }
